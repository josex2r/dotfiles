...
M.on_attach = function(client, bufnr)
	...
	buf_set_keymap("n", "<leader>ca", "<cmd>lua require('telescope.builtin').lsp_code_actions({layout_config={width=0.5,height=0.5}})<CR>", opts)
	buf_set_keymap("v", "<leader>ca", "<cmd>lua require('telescope.builtin').lsp_range_code_actions({layout_config={width=0.5,height=0.5}})<CR>", opts)
